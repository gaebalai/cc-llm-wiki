...
| L3a Graph | Neo4j + 고정 Cypher | 다중-홉 관계 탐색 — [[graphrag-poc-with-neo4j]] |
| L3b Index | Kagura MCP (BM25+벡터+Hebbian, P6 옵션) | 의미·키워드 검색 |
...
- **[[entity-disambiguation-strategy]] 가 L3a 품질의 핵심**: 정규화 없는 그래프는 인과 경로가 끊긴다.
- **L3a 와 L3b 는 통합 아닌 역할 분담**: 라우터 Skill(`query`)가 질의 의도를 분류해 적절한 층으로 위임.
